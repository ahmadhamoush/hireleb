    ...
    <div className={style.wrapper}>
      <div className={style.container}>
        <div className={style.descriptionContainer}>
          <h2>
            Get the Job Done with Ease - Let Us Connect You with Top Talent!
          </h2>
        ...
        <div className={style.phone}>
          <div className={style.freelancer}>
            ...
            <p className={style.totalProjects}>
              Total Projects <span>180</span>
            </p>
          ...
          <Image
            ...
            src="/phone1.png"
            fill
            alt="Lebanese Freelancers"
          />
        </div>
      </div>
      <Link href="/freelancers" className={style.all}>
        <p>All Freelancers</p> <FontAwesomeIcon icon={faArrowRight} />
      </Link>
    </div>
  )
}
