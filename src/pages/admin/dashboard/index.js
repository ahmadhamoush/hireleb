              ...
              return (
                <div key={job._id} className={style.card}>
                  <div className={style.infos}>
                    <div className={style.info}>
                      <div>
                        <p className={style.name}>{job.title}</p>
                        <p className={style.function}>Desc {job.description}</p>
                        <p className={style.function}>
                          Category {job.category}
                        </p>
                        <p className={style.function}>Skills {job.skills}</p>
                        <p className={style.function}>
        ...
        {isServices && (
          <div className={style.wrapper}>
            {services.map((service) => {
              return (
                <div key={service._id} className={style.card}>
                  <div className={style.infos}>
                    <div className={style.info}>
                      <div>
                        <p className={style.name}>{service.name}</p>
                        <p className={style.function}>Desc {service.desc}</p>
                        <p className={style.function}>
        ...
        {isDeposits && (
          <div className={style.wrapper}>
            {deposits.map((deposit) => {
              return (
                <div key={deposit._id} className={style.card}>
                  <div className={style.infos}>
                    <Image
                      alt="receipt"
                      src={deposit.receipt}
                    ...
                    <div className={style.info}>
                      <div>
                        <p className={style.name}>{deposit.user}</p>
                        <p className={style.function}>{deposit.date}</p>
                      </div>
                      <div className={style.stats}>
                        <p className={`${style.flex} ${style.flexCol}`}>
                          Status
                      ...
                      {deposit.status === 'pending' && (
                        <div className={style.btns}>
                          ...
                          <button onClick={() => decline(deposit._id)}>
                            Decline
                          </button>
                        </div>
                      )}
        ...
        {isWithdraws && (
          <div className={style.wrapper}>
            {withdraws.map((withdraw) => {
              return (
                <div key={withdraw._id} className={style.card}>
                  <div className={style.infos}>
                    <div className={style.info}>
                      <div>
                        <p className={style.name}>{withdraw.user}</p>
                        <p className={style.function}>{withdraw.date}</p>
                      </div>
                      <div className={style.stats}>
                        <p className={`${style.flex} ${style.flexCol}`}>
                          Status
                      ...
                      {withdraw.status === 'pending' && (
                        <div className={style.btns}>
                          ...
                          <button onClick={() => decline(withdraw._id)}>
                            Decline
                          </button>
                        </div>
                      )}
