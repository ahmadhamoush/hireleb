...
const How = () => {
  ...
  return (
    <Layout>
       ...
       <h1>How Hire<span>Leb</span> Works</h1>
       <div className={style.wrapper}>
            <h3>Buyers</h3>
            <p>As a buyer on our platform, you have access to a pool of talented freelancers and agencies to help you get your projects done. Post your project, receive proposals from qualified professionals, and select the right fit for your project.
            </p>
       ...
       <div className={style.wrapper}>
            <h3>Freelancers</h3>
            <p>As a freelancer on our platform, you have the opportunity to showcase your skills and connect with clients looking for your services. Create a profile, showcase your portfolio, and start applying for jobs today.
            </p>
